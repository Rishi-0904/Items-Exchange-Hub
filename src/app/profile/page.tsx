  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        ...
        {/* Stats Cards */}
        <div className="p-6">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Your Items</h2>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow-sm">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{userStats.totalItems}</p>
              </div>
              ...
              <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg shadow-sm">
                ...
                <p className="text-2xl font-bold text-green-700 dark:text-green-300">{userStats.itemsAvailable}</p>
              </div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/30 p-4 rounded-lg shadow-sm">
                ...
                <p className="text-2xl font-bold text-yellow-700 dark:text-yellow-300">{userStats.itemsReserved}</p>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-900/30 p-4 rounded-lg shadow-sm">
                ...
                <p className="text-2xl font-bold text-red-700 dark:text-red-300">{userStats.itemsSold}</p>
              </div>
            </div>
          )}
        </div>
